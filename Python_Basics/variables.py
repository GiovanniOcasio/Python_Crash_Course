...
#We can also assign the values for multiple variables in a single line
w, x, y, z = 'My', 'Name', 'Is', 'Gio'
print(w)
print(x)
print(y)
print(z)
...
example = "this is originally stored in all lowercase"
...
#Python doesn't have built in constant types, typically Python developers will create a variable that is all uppercase to signify that it should not be changed
